...
class IssueIO extends Bundle{
  ...
  val dispatch_info = Vec(7,Decoupled(new DispatchInfo))
...
class Issue extends Module{
  ...
  val alu_rs           = Seq.fill(4)(Module(new ReservationStation(8)))
  val bju_rs           = Seq.fill(1)(Module(new ReservationStation(8)))
  val mdu_rs           = Seq.fill(1)(Module(new ReservationStation(8)))
